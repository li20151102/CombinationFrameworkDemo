...
public class LineChartView extends View {
    ...
    // 坐标轴底部的星期数
    private String[] str = { "62", "72", "82", "92", "102", "112", "122", "132", "142" };
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        text = new int[] { 356, 565, 385, 674, 235, 193, 212, 533, 351, 171 };
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < 10; i++) {// 画x线，并在左侧显示相应的数值
            ...
            if (i == 2) {
                ...
                titlePaint.getTextBounds(str[i - 1], 0, str[i - 1].length(), bundle1);
                canvas.drawText(str[i - 1], dp2px(25) - bundle1.width(),
                        i * hPerHeight + (bundle1.height() / 2), titlePaint);
            } else {
                ...
                if (i != 0) {
                    ...
                    canvas.drawText(str[i - 1], dp2px(25) - bundle2.width(),
                            i * hPerHeight + (bundle2.height() / 2), titlePaint);
                }
            }
